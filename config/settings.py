...
SECRET_KEY = environ.get(
    "DJANGO_SECRET_KEY",
    'django-insecure-_s!0e25(jbtt94do1vvd1b14c$qy$p1hcj^8@+r-6!bm)!szvg'
)

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = bool(environ.get('DJANGO_DEBUG', 1))
...
DATABASES = {
    'default': {
        ...
        'USER': environ.get('DJANGO_DB_USER', 'django'),
        'PASSWORD': environ.get('DJANGO_DB_PASSWORD', 'django'),
        'HOST': environ.get('DJANGO_DB_HOST', '127.0.0.1'),
...
CORS_ALLOWED_ORIGINS = environ.get('DJANGO_CORS_ORIGINS', '').split() or [
    "http://127.0.0.1:5173"
]
